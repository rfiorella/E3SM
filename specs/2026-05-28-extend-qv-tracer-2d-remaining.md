...
success_criteria:
  - id: compile-all-processes-n1
    type: shell
    cmd: "cd components/eamxx && cmake -S . -B build/pr2d-n1 -DCMAKE_BUILD_TYPE=Debug -DSCREAM_NUM_TRACERS=1 -DSCREAM_TRACER_ACCESS={{PATTERN}} && cmake --build build/pr2d-n1 -j"
    expect: exit_zero
